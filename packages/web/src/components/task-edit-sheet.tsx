...
export function TaskEditSheet({
  ...
  const [availableLabels, setAvailableLabels] =
    useState<LabelDto[]>(initialLabels);
      ...
      <SheetContent side="right" className="w-[90%] sm:max-w-md overflow-y-auto">
        ...
        <div className="mt-6 space-y-6 p-4">
          ...
          <form.Field name="labelIds">
            {(field) => {
              // Optimization: Use a Set for O(1) membership lookups to avoid O(N*M) complexity
              // during rendering, especially for long lists of labels.
